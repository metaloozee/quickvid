      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="space-y-5">
            <p className="mt-3">
              This is a open-sourced project and to be useful enough we need to
              use your OpenAI API Key.
            </p>
            <p>
              Worried about the privacy? The token you enter below will be
              stored inside the browser&apos; local storage, not our cloud
              database!
            </p>
            <Form {...form}>
              <form
              ...
              >
                <FormField
                  ...
                  render={({ field }) => (
                    <FormControl>
                      <Input disabled={loading} placeholder="OpenAI API Key" {...field} />
                    </FormControl>
                  )}
                />
                {!loading ? (
